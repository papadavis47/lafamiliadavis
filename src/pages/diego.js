      ...
      <main className={styles.page}>
        <div className={styles.gridContainer}>
          <div className={styles.gridItem1}>
            ...
            <p>
              He loves computer gaming ( Fortnite, Roblox, Minecraft ) and he enjoys spending time
              with his family and with his friends from school.
            </p>
            <p>He is good at many different things. </p>
            <p>
              All of his life he has had a wonderful sense of humour. From the time he was a baby -
              he has loved to laugh. And he has always been funny 😆
            </p>
            <p>
